<template>
  <div class="fixed top-4 left-0 right-0 z-[100] flex flex-col items-center px-4">
    ...
    <!-- Nav bar -->
    <nav
      class="w-full max-w-6xl transition-all duration-500 px-4"
      ...
      <div class="flex items-center justify-between h-13">
        ...
        <a href="#" @click="scrollToTop" class="shrink-0">
          <img
            ...
            alt="Deenex"
            class="h-[22px] w-auto transition-all duration-500"
        ...
        <div class="hidden md:flex items-center gap-1">
          <a
            ...
            :key="link.label"
            :href="link.href"
            class="px-3.5 py-2 text-[0.82rem] font-semibold rounded-xl transition-all duration-200"
            :class="scrolled
